...
if (isset($_POST["submit"])) {
    if ($_POST["submit"] == "Update") {
        ...
        if ($data) {
            ...
            $nim = $nama = $tempat_lahir = $fakultas = $jurusan = $ipk = $tanggal_lahir = $jenis_kelamin = "";
        }
...
<body class="bg-light">
    <div class="container mt-5 border rounded bg-white py-4 px-5 mb-5">
        <header class="header-title mb-4">
            <h1><a href="./index.php" style="text-decoration:none;"><span class="fw-normal text-dark">Informatika</span> <span class="textprimary">Mahasiswa</span></a></h1>
            <hr>
        </header>
        ...
        <section>
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form">
                <div class="mb-3">
                    ...
                    <input type="text" name="nim" id="nim" class="formcontrol" value="<?php echo isset($nim) ? $nim : ""; ?>" placeholder="Contoh: 1234567">
                    <span class="text-muted">(7 digit angka)</span>
                </div>

                <div class="mb-3">
                    <label for="nama" class="form-label">Nama</label>
                    <input type="text" name="nama" id="nama" class="formcontrol" value="<?php echo isset($nama) ? $nama : ""; ?>" placeholder="Masukkan Nama Kamu">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="perempuan" name="jenis_kelamin" value="Perempuan" <?php echo (isset($jenis_kelamin) && $jenis_kelamin === "Perempuan") ? "checked" : ""; ?>>
                ...
                <div class="mb-3">
                    ...
                    <select name="fakultas" id="fakultas" class="form-select">
                        ...
                        <?php
                            $faculties = ["FIK", "FH", "FISIP", "FT", "FIKES", "FK", "FEB"];
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="jurusan" id="jurusan" class="formcontrol" value="<?php echo isset($jurusan) ? $jurusan : ""; ?>" placeholder="Masukkan Jurusan">
                </div>

                <div class="mb-3">
                    <label for="ipk">IPK</label>
                    <input type="text" name="ipk" id="ipk" class="formselect" value="<?php echo isset($ipk) ? $ipk : ""; ?>" placeholder="Contoh: 3.85">
