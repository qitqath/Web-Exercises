...
<head>
    <meta charset="UTF-8">
    <title>Informatika Mahasiswa</title>
    ...
    <div class="container mt-5 border rounded bg-white py-4 px-5 mb-5">
        ...
        <section>
            ...
            if (
                ...
                echo "<div class=\"alert alert-danger mb3\"> <ul class=\"m-0\">$error_message</ul> </div>";
            }
            ?>
...
label">Jenis Kelamin</label>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="laki-laki">Laki
                            laki</label>
                    </div>
                    <div class="form-check form-check-inline">
